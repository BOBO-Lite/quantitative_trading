...
REQUESTS = [('000333.SZ', '2019-04-17'), ('000333.SZ', '2019-04-18'), ('000333.SZ', '2019-04-19'), ('000333.SZ', '2019-04-22'), ('000333.SZ', '2019-04-23'), ('000333.SZ', '2019-04-24'), ('000333.SZ', '2019-05-06'), ('000333.SZ', '2019-05-07'), ('000333.SZ', '2019-05-08'), ('000333.SZ', '2019-05-09'), ('000333.SZ', '2019-05-10'), ('000333.SZ', '2019-05-13'), ('600025.SH', '2020-08-17'), ('600025.SH', '2020-08-18'), ('600025.SH', '2020-08-19'), ('600025.SH', '2020-08-21'), ('600025.SH', '2020-08-24'), ('601198.SH', '2019-12-30'), ('601198.SH', '2019-12-31')]
...
def before_trading(context):
    ...
    for offset in range(0,len(symbols),50):
        frames=get_price(symbols[offset:offset+50],'20171201','20201231','1d',fields,skip_paused=False,fq=None,is_panel=False)
