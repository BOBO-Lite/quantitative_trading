...
def before_trading(context):
    ...
    for s in SYMBOLS:
        try:
            ...
            f=get_price([s],'20170101','20260904','1d',fields,skip_paused=False,fq=None,is_panel=False)[s]
        ...
        try:
            f=get_dividend_information(s,start_date='20170101',end_date='20260904')
    ...
    emit('etf_calendar',dict(data=packet(get_price(['000300.SH'],'20170101','20260904','1d',['close'],skip_paused=False,fq=None,is_panel=False)['000300.SH'])))
